...
<div id="micontainer" style="background: transparent; width: 100%; height: 100%; position: absolute;">
  ...
  <center><img src="https://i.ibb.co/hgYWPF5/FM-VIDA-97-9.png" style="margin-top:5%" width="380px" class="img-responsive" ></center>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Musica</title>
<link href="ancho.css" rel="stylesheet" type="text/css">
</head>
<body>
...
MRP.insert({ 
'url':'https://streaming450tb.locucionar.com/proxy/fmvida979?mp=/stream',
'codec':'aac',
'volume':100,
'autoplay':true,
'jsevents':true,
